# -*- coding: utf-8 -*-
#
# UI cases documentation build configuration file, created by
# sphinx-quickstart on Thu Nov  3 00:56:37 2016.
#
...
sys.path.insert(0, os.path.abspath('../..'))  # inject project root path
...
latex_documents = [
    (master_doc, 'UIcases.tex', u'UI cases Documentation',
...
man_pages = [
    (master_doc, 'uicases', u'UI cases Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'UIcases', u'UI cases Documentation',
     author, 'UIcases', 'One line description of project.',
     'Miscellaneous'),
]
